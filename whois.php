...
*************************************************************************/
Çeviri ve Güncelleme: https://haktanbozer.com.tr
==========================================================================
...
if(!$whoisserver) {
return "Hata: $domain alan adı için yaptığınız aramayı gerçekleştirmek için tanımlı sunucu bulunamadı";
}
$result = QueryWhoisServer($whoisserver, $domain);
if(!$result) {
return "Hata: $domain alan adı için $whoisserver sunucusundan yanıt alınamadı";
}
else {
...
return "$domain i&#231in g&#246sterilen bilgiler $whoisserver sunucusundan al&#305nm&#305&#351;t&#305r\n\n" . $result;
}
...
<p><b><label for="domain">Alan Ad&#305 veya IP Adresi:</label></b> <input type="text" name="domain" id="domain" value="<?=$domain;?>"> <input type="submit" value="Ara"></p>
</form>
<?php
if($domain) {
$domain = trim($domain);
